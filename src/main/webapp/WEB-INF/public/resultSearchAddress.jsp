								...
								<div class="col-md-12 nav-link-wrap">
									<div class="nav nav-pills text-center" id="v-pills-tab"
										...
										<a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab"
											aria-controls="v-pills-3" aria-selected="false">Tìm theo địa điểm</a>
									</div>
								</div>
								<div class="col-md-12 tab-wrap">
									<div class="tab-content p-4" id="v-pills-tabContent">
										<div class="tab-pane fade show active" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-performance-tab">
				...
				<div v-if="totalCount > 0" class="col-lg-12 pr-lg-12">
					<div class="row justify-content-center pb-3">
						<div class="col-md-12 heading-section ">
							<h2 class="mb-4"> Kết quả tìm kiếm cho "<span>{{key}}</span> " </h2>
						</div>
					</div>
						...
						<div class="col-md-12 ">
							<div class="job-post-item p-4 d-block d-lg-flex align-items-center">
								...
								<div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0" style="width: 330px !important;">
									<div>
										<div v-if="rec.isFollow == false" @click="folowRecuitment(rec.id, true)"
											class=" text-center d-flex justify-content-center align-items-center icon mr-2">
											<span class="icon-heart"></span>
										</div>
										<div v-if="rec.isFollow == true" @click="folowRecuitment(rec.id, false)"
...
<script src="<c:url value='/assets/js/export/commons.js' /> "></script><script src="<c:url value='/assets/js/export/resultSearchAddress.js' /> "></script>
