                        ...
                        <div class="col-md-12 ">
                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                ...
                                <div  class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
                                    ...
                                    <a v-if="rec.isApply == false" @click="openModalApplyPost(rec.id)" class="btn btn-primary py-2">Apply Job</a>
                                    <a v-if="rec.isApply == true" class="btn btn-secondary disabled py-2">Applied</a>
                                </div>
                            </div>
                        </div><!-- end -->
                        <!-- Modal -->
